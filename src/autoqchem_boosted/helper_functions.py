...
def atommap_molecule(smi): #adds atom-mapping to a molecule given its SMILES string
    ...
    for a in mol.GetAtoms():
        ...
        unmapped += 1
    atommapped_mol = mol
    atommapped_smi = Chem.MolToSmiles(atommapped_mol)
    return atommapped_mol,atommapped_smi
